    ...
    try
    {
        ...
        if ($null -eq $request)
        {
            ...
            else
            {
                ...
                Write-Verbose -Message "Found Principal {$PrincipalId}"
                $schedulesForPrincipal = Get-MgBetaRoleManagementDirectoryRoleAssignmentSchedule -Filter "PrincipalId eq '$PrincipalId'"
                ...
                [Array]$request = Get-MgBetaRoleManagementDirectoryRoleAssignmentScheduleRequest -Filter "PrincipalId eq '$PrincipalId'" | Where-Object -FilterScript {$_.RoleDefinitionId -eq $schedule.RoleDefinitionId} | Sort-Object -Property CompletedDateTime -Descending
`
