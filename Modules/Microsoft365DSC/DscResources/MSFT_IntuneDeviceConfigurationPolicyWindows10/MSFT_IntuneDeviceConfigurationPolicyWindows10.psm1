        ...
        try
        {
            ...
            foreach ($config in $getValue)
            {
                ...
                $currentDSCBlock = Get-M365DSCExportContentForResource -ResourceName $this.GetResourceName() `
                    ...
                    -Results $Results `
                    -Credential $this.Credential `
                    -NoEscape @('DefenderDetectedMalwareActions', 'DeviceManagementApplicabilityRuleOsEdition',
                    'DeviceManagementApplicabilityRuleOsVersion', 'EdgeHomeButtonConfiguration', 'EdgeSearchEngine',
