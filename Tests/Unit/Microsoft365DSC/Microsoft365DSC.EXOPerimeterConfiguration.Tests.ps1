    ...
    InModuleScope -ModuleName $Global:DscHelper.ModuleName -ScriptBlock {
        ...
        Context -Name 'Config is not in the desired state' -Fixture {
            ...
            It 'Should return false from the Test method' {
                (New-M365DSCResourceInstance -ResourceName 'EXOPerimeterConfiguration' -Property $testParams).Test() | Should -Be $false
            }

            It 'Should call the Set method' {
                (New-M365DSCResourceInstance -ResourceName 'EXOPerimeterConfiguration' -Property $testParams).Set()
        ...
        Context -Name 'Config is already in the desired state' -Fixture {
            ...
            It 'Should return false from the Test method' {
                (New-M365DSCResourceInstance -ResourceName 'EXOPerimeterConfiguration' -Property $testParams).Test() | Should -Be $true
            }
        }
        ...
        Context -Name 'ReverseDSC Tests' -Fixture {
            ...
            It 'Should Reverse Engineer resource from the Export' {
                $result = Invoke-M365DSCResourceMethod -ResourceName 'EXOPerimeterConfiguration' -MethodName 'Export' -Parameters $testParams
