    ...
    InModuleScope -ModuleName $Global:DscHelper.ModuleName -ScriptBlock {
        ...
        Context -Name 'Organization Relationship should exist. Organization Relationship is missing. Test should fail.' -Fixture {
            ...
            It 'Should return false from the Test method' {
                (New-M365DSCResourceInstance -ResourceName 'EXOOrganizationRelationship' -Property $testParams).Test() | Should -Be $false
            }

            It 'Should call the Set method' {
                (New-M365DSCResourceInstance -ResourceName 'EXOOrganizationRelationship' -Property $testParams).Set()
                Should -Invoke -CommandName New-OrganizationRelationship -Exactly 1
            }

            It 'Should return Absent from the Get method' {
                ((New-M365DSCResourceInstance -ResourceName 'EXOOrganizationRelationship' -Property $testParams).Get().ToHashtable()).Ensure | Should -Be 'Absent'
            }
        }
        ...
        Context -Name 'Organization Relationship should exist. Organization Relationship exists. Test should pass.' -Fixture {
            ...
            It 'Should return true from the Test method' {
                (New-M365DSCResourceInstance -ResourceName 'EXOOrganizationRelationship' -Property $testParams).Test() | Should -Be $true
            }

            It 'Should return Present from the Get Method' {
                ((New-M365DSCResourceInstance -ResourceName 'EXOOrganizationRelationship' -Property $testParams).Get().ToHashtable()).Ensure | Should -Be 'Present'
            }
        }
        ...
        Context -Name 'ReverseDSC Tests' -Fixture {
            ...
            It 'Should Reverse Engineer resource from the Export method when single' {
                $result = Invoke-M365DSCResourceMethod -ResourceName 'EXOOrganizationRelationship' -MethodName 'Export' -Parameters $testParams
