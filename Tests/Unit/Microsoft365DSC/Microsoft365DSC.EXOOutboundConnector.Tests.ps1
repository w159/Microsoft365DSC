    ...
    InModuleScope -ModuleName $Global:DscHelper.ModuleName -ScriptBlock {
        ...
        Context -Name 'OutboundConnector creation.' -Fixture {
            ...
            It 'Should return Absent from the Get method' {
                ((New-M365DSCResourceInstance -ResourceName 'EXOOutboundConnector' -Property $testParams).Get().ToHashtable()).Ensure | Should -Be 'Absent'
            }

            It 'Should return false from the Test method' {
                (New-M365DSCResourceInstance -ResourceName 'EXOOutboundConnector' -Property $testParams).Test() | Should -Be $false
            }

            It 'Should call the Set method' {
                (New-M365DSCResourceInstance -ResourceName 'EXOOutboundConnector' -Property $testParams).Set()
        ...
        Context -Name 'OutboundConnector update not required.' -Fixture {
            ...
            It 'Should return true from the Test method' {
                (New-M365DSCResourceInstance -ResourceName 'EXOOutboundConnector' -Property $testParams).Test() | Should -Be $true
            }
        }
        ...
        Context -Name 'Connector Source is AdminUI' -Fixture {
            ...
            It 'Should return Default as the source from the Get method' {
                ((New-M365DSCResourceInstance -ResourceName 'EXOOutboundConnector' -Property $testParams).Get().ToHashtable()).ConnectorSource | Should -Be 'Default'
            }
        }
        ...
        Context -Name 'ReverseDSC Tests' -Fixture {
            ...
            It 'Should Reverse Engineer resource from the Export method' {
                $result = Invoke-M365DSCResourceMethod -ResourceName 'EXOOutboundConnector' -MethodName 'Export' -Parameters $testParams
