    ...
    InModuleScope -ModuleName $Global:DscHelper.ModuleName -ScriptBlock {
        ...
        Context -Name 'When settings are correctly set' -Fixture {
            ...
            It 'Should return true for the AllowIPVideo property from the Get method' {
                ((New-M365DSCResourceInstance -ResourceName 'TeamsGuestMeetingConfiguration' -Property $testParams).Get().ToHashtable()).AllowIPVideo | Should -Be $true
            }

            It 'Should return true from the Test method' {
                (New-M365DSCResourceInstance -ResourceName 'TeamsGuestMeetingConfiguration' -Property $testParams).Test() | Should -Be $true
            }

            It 'Updates the settings in the Set method' {
                (New-M365DSCResourceInstance -ResourceName 'TeamsGuestMeetingConfiguration' -Property $testParams).Set()
            }
        }
        ...
        Context -Name 'When settings are NOT correctly set' -Fixture {
            ...
            It 'Should return false from the Test method' {
                (New-M365DSCResourceInstance -ResourceName 'TeamsGuestMeetingConfiguration' -Property $testParams).Test() | Should -Be $false
            }
        ...
        Context -Name 'ReverseDSC Tests' -Fixture {
            ...
            It 'Should Reverse Engineer resource from the Export method' {
                $result = Invoke-M365DSCResourceMethod -ResourceName 'TeamsGuestMeetingConfiguration' -MethodName 'Export' -Parameters $testParams
