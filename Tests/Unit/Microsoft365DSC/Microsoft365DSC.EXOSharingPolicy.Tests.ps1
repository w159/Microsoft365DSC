    ...
    InModuleScope -ModuleName $Global:DscHelper.ModuleName -ScriptBlock {
        ...
        Context -Name 'Sharing Policy should exist. Sharing Policy is missing. Test should fail.' -Fixture {
            ...
            It 'Should return false from the Test method' {
                (New-M365DSCResourceInstance -ResourceName 'EXOSharingPolicy' -Property $testParams).Test() | Should -Be $false
            }

            It 'Should call the Set method' {
                (New-M365DSCResourceInstance -ResourceName 'EXOSharingPolicy' -Property $testParams).Set()
                Should -Invoke -CommandName New-SharingPolicy -Exactly 1
            }

            It 'Should return Absent from the Get method' {
                ((New-M365DSCResourceInstance -ResourceName 'EXOSharingPolicy' -Property $testParams).Get().ToHashtable()).Ensure | Should -Be 'Absent'
            }
        }
        ...
        Context -Name 'Sharing Policy should exist. Sharing Policy exists. Test should pass.' -Fixture {
            ...
            It 'Should return true from the Test method' {
                (New-M365DSCResourceInstance -ResourceName 'EXOSharingPolicy' -Property $testParams).Test() | Should -Be $true
            }

            It 'Should return Present from the Get Method' {
                ((New-M365DSCResourceInstance -ResourceName 'EXOSharingPolicy' -Property $testParams).Get().ToHashtable()).Ensure | Should -Be 'Present'
            }
        }
        ...
        Context -Name 'ReverseDSC Tests' -Fixture {
            ...
            It 'Should Reverse Engineer resource from the Export method when single' {
                $result = Invoke-M365DSCResourceMethod -ResourceName 'EXOSharingPolicy' -MethodName 'Export' -Parameters $testParams
