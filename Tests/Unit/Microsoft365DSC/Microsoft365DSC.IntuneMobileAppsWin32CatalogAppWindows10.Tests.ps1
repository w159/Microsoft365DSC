...
$Global:DscHelper = New-M365DscUnitTestHelper -StubModule $CmdletModule `
    -DscResource 'IntuneMobileAppsWin32CatalogAppWindows10' -GenericStubModule $GenericStubPath
    ...
    InModuleScope -ModuleName $Global:DscHelper.ModuleName -ScriptBlock {
        ...
        BeforeAll {
            ...
            Mock -CommandName Get-MgBetaDeviceAppManagementMobileApp -MockWith {
                return @{
                    ...
                    displayVersion                 = 'FakeStringValue'
                    fileName                       = 'FakeStringValue'
                    installCommandLine             = 'FakeStringValue'
                    installExperience              = @{
                        deviceRestartBehavior = 'basedOnReturnCode'
                        inUseBehavior         = 'notEnabled'
                        maxRunTimeInMinutes   = 25
                        runAsAccount          = 'system'
                    }
                    minimumCpuSpeedInMHz           = 25
                    minimumFreeDiskSpaceInMB       = 25
                    minimumMemoryInMB              = 25
                    minimumNumberOfProcessors      = 25
                    minimumSupportedWindowsRelease = 'FakeStringValue'
                    mobileAppCatalogPackageId      = 'FakeStringValue'
                    msiInformation                 = @{
                        packageType    = 'perMachine'
                        productCode    = 'FakeStringValue'
                        productName    = 'FakeStringValue'
                        productVersion = 'FakeStringValue'
                        publisher      = 'FakeStringValue'
                        requiresReboot = $true
                        upgradeCode    = 'FakeStringValue'
                    }
                    returnCodes                    = @(
                        @{
                            returnCode = 25
                    ...
                    rules                          = @(
                        @{
                            ...
                            comparisonValue        = 'FakeStringValue'
                            displayName            = 'FakeStringValue'
                            enforceSignatureCheck  = $true
                            fileOrFolderName       = 'FakeStringValue'
                            keyPath                = 'FakeStringValue'
                            '@odata.type'          = '#microsoft.graph.win32LobAppFileSystemRule'
                            operationType          = 'notConfigured'
                            operator               = 'notConfigured'
                            path                   = 'FakeStringValue'
                            processDisplayName     = 'FakeStringValue'
                            processName            = 'FakeStringValue'
                            productCode            = 'FakeStringValue'
                            productVersion         = 'FakeStringValue'
                            ...
                            runAs32Bit             = $true
                            runAsAccount           = 'system'
                            scriptContent          = 'FakeStringValue'
                            valueName              = 'FakeStringValue'
                        }
                    )
            ...
            Mock -CommandName Get-M365DSCExportContentForResource -MockWith {
                return "IntuneMobileAppsWin32CatalogAppWindows10 'TestInstance' {}`r`n"
            }
        ...
        Context -Name 'The instance should exist but it DOES NOT' -Fixture {
            ...
            It 'Should return Absent from the Get method' {
                ((New-M365DSCResourceInstance -ResourceName 'IntuneMobileAppsWin32CatalogAppWindows10' -Property $testParams).Get().ToHashtable()).Ensure | Should -Be 'Absent'
                Should -Invoke -CommandName 'Get-MgBetaDeviceAppManagementMobileApp'
            }

            It 'Should return false from the Test method' {
                (New-M365DSCResourceInstance -ResourceName 'IntuneMobileAppsWin32CatalogAppWindows10' -Property $testParams).Test() | Should -Be $false
            }
        ...
        Context -Name 'The instance exists but it SHOULD NOT' -Fixture {
            ...
            It 'Should return Present from the Get method' {
                ((New-M365DSCResourceInstance -ResourceName 'IntuneMobileAppsWin32CatalogAppWindows10' -Property $testParams).Get().ToHashtable()).Ensure | Should -Be 'Present'
                Should -Invoke -CommandName 'Get-MgBetaDeviceAppManagementMobileApp'
            }
        ...
        Context -Name 'The instance exists and values are already in the desired state' -Fixture {
            ...
            It 'Should return the expected values from the Get method' {
                $result = (New-M365DSCResourceInstance -ResourceName 'IntuneMobileAppsWin32CatalogAppWindows10' -Property $testParams).Get().ToHashtable()
                ...
                $result.FileName | Should -Be 'FakeStringValue'
                $result.Id | Should -Be 'FakeStringValue'
                $result.InformationUrl | Should -Be 'FakeStringValue'
                $result.InstallCommandLine | Should -Be 'FakeStringValue'
                $result.IsFeatured | Should -Be $true
                $result.MinimumCpuSpeedInMHz | Should -Be 25
                $result.MinimumFreeDiskSpaceInMB | Should -Be 25
                $result.MinimumMemoryInMB | Should -Be 25
                $result.MinimumNumberOfProcessors | Should -Be 25
                $result.MinimumSupportedWindowsRelease | Should -Be 'FakeStringValue'
                $result.MobileAppCatalogPackageId | Should -Be 'FakeStringValue'
                ...
                $result.SetupFilePath | Should -Be 'FakeStringValue'
                $result.UninstallCommandLine | Should -Be 'FakeStringValue'
                Should -Invoke -CommandName 'Get-MgBetaDeviceAppManagementMobileApp'
            }

            It 'Should return true from the Test method' {
                (New-M365DSCResourceInstance -ResourceName 'IntuneMobileAppsWin32CatalogAppWindows10' -Property $testParams).Test() | Should -Be $true
            }
        }
        ...
        Context -Name 'ReverseDSC Tests' -Fixture {
            ...
            It 'Should reverse engineer resource from the Export method' {
                $result = Invoke-M365DSCResourceMethod -ResourceName 'IntuneMobileAppsWin32CatalogAppWindows10' -MethodName 'Export' -Parameters $testParams
