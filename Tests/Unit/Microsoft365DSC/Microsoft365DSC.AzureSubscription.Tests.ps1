    ...
    InModuleScope -ModuleName $Global:DscHelper.ModuleName -ScriptBlock {
        ...
        Context -Name "The instance doesn't exists and it should" -Fixture {
            ...
            It 'Should return false from the Test method' {
                (New-M365DSCResourceInstance -ResourceName 'AzureSubscription' -Property $testParams).Test() | Should -Be $false
            }
        }
        ...
        Context -Name "The instance exists and values are already in the desired state" -Fixture {
            ...
            It 'Should return true from the Test method' {
                (New-M365DSCResourceInstance -ResourceName 'AzureSubscription' -Property $testParams).Test() | Should -Be $true
            }

            It 'Should call the Set method' {
                (New-M365DSCResourceInstance -ResourceName 'AzureSubscription' -Property $testParams).Set()
        ...
        Context -Name "The instance exists and values are NOT in the desired state" -Fixture {
            ...
            It 'Should return Values from the Get method' {
                ((New-M365DSCResourceInstance -ResourceName 'AzureSubscription' -Property $testParams).Get().ToHashtable()).Ensure | Should -Be 'Present'
            }
        ...
        Context -Name 'ReverseDSC Tests' -Fixture {
            ...
            It 'Should Reverse Engineer resource from the Export method' {
                $result = Invoke-M365DSCResourceMethod -ResourceName 'AzureSubscription' -MethodName 'Export' -Parameters $testParams
