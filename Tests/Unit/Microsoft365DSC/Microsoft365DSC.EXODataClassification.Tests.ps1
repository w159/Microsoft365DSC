    ...
    InModuleScope -ModuleName $Global:DscHelper.ModuleName -ScriptBlock {
        ...
        Context -Name "Classification doesn't exist and it should" -Fixture {
            ...
            It 'Should return False from the Get method' {
                ((New-M365DSCResourceInstance -ResourceName 'EXODataClassification' -Property $testParams).Get().ToHashtable()).Ensure | Should -Be 'Absent'
            }
        }
        ...
        Context -Name 'Classification already exists and should be updated' -Fixture {
            ...
            It 'Should return False from the Get method' {
                ((New-M365DSCResourceInstance -ResourceName 'EXODataClassification' -Property $testParams).Get().ToHashtable()).Ensure | Should -Be 'Present'
            }

            It 'Should call into the Set-DataClassification command exactly once' {
                (New-M365DSCResourceInstance -ResourceName 'EXODataClassification' -Property $testParams).Set()
        ...
        Context -Name 'ReverseDSC Tests' -Fixture {
            ...
            It 'Should Reverse Engineer resource from the Export method' {
                $result = Invoke-M365DSCResourceMethod -ResourceName 'EXODataClassification' -MethodName 'Export' -Parameters $testParams
